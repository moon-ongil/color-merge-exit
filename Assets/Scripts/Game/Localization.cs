...
namespace ColorMergeExit.Game
{
        ...
        private static readonly Dictionary<Locale, Dictionary<string, string>> Tables =
            new Dictionary<Locale, Dictionary<string, string>>
            {
                [Locale.En] = new Dictionary<string, string>
                {
                    ...
                    [LocKeys.DeadEndNoDoors] = "No doors left for the blocks on the board",
                ...
                [Locale.Ko] = new Dictionary<string, string>
                {
                    ...
                    [LocKeys.DeadEndNoDoors] = "남은 블록이 나갈 문이 없어요",
    ...
    public static class LocKeys
    {
        ...
        // Why the board is dead. DeadEndStranded takes the offending block's colour name as {0}.
        public const string DeadEndNoDoors = "game.deadend.nodoors";
